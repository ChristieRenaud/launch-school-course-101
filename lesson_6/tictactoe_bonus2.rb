...
def mark_critical_square(brd, space)
  square_to_mark = nil
  WINNING_LINES.each do |line|
    square_to_mark = find_at_risk_square(line, brd, space)
...
def computer_places_piece!(brd)
  square = mark_critical_square(brd, COMPUTER_MARKER)

  if !square
    square = mark_critical_square(brd, PLAYER_MARKER)
  end
